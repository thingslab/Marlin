...
// default settings
//#define DEFAULT_AXIS_STEPS_PER_UNIT   {64,64,5120.00,760*1*1.5} 
//#define DEFAULT_AXIS_STEPS_PER_UNIT   {78.7402,78.7402,5120.00,760*1*1.5}
//#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,731.43,760*1*1.5}
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,731.43,900}
//#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,4000,760*1*1.5}// default steps per unit for ultimaker 
